...
/* Please copy the following lines to the thesis custom_functions.php file in the custom folder. This class
 * is tested with thesis 1.8.
 *
 * Bibliplug custom loop for author archive page.
 * 
 */

global $loopty_loop;
$loopty_loop = new bibliplug_loops;

class bibliplug_loops extends thesis_custom_loop {
	function author() {
		global $wp_query, $thesis_design;
