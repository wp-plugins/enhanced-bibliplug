...
class phpZotero {
     ...
     * @param string The library type, users or groups
     */
    public function getItemsTop($zoteroId, $parameters = array(), $libraryType="users", $headers=array()) {
        return $this->_zoteroRequest("$libraryType/$zoteroId/items/top", $parameters, null, 'GET', $headers);
    }
     ...
     * @param string The library type, users or groups
     */
    public function getCollectionItems($zoteroId, $collectionKey, $parameters = array(), $libraryType="users", $headers=array()) {
        return $this->_zoteroRequest("$libraryType/$zoteroId/collections/$collectionKey/items", $parameters, NULL, 'GET', $headers);
    }
